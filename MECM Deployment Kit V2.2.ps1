...
<Settings>
    <MECMSettings>
        ...
        <MECMSERVER>Server-100</MECMSERVER>
    </MECMSettings>
    <EmailSettings>
        <SMTPServer>App-mail.abc.corp..ca</SMTPServer>
        <FromAddress>MECM_Automation@abc.com</FromAddress>
        <CCAddress>SCCM.Ops.IN@abc.com</CCAddress>
        <BCCAddress></BCCAddress>
    </EmailSettings>
    <ToolSettings>
        <MailList>Antony@abc.com;Praveen@abc.com;kumar@abc.com;SCCM_team@abc.com;</MailList>
...
"@  
    ...
    $CM_TSDeploy = New-CMTaskSequenceDeployment -TaskSequencePackageId $CM_DTS.PackageID -DeployPurpose Required -AvailableDateTime $($Time_available.Value).AddMinutes(30) -UseUtcForAvailableSchedule $cm_tsaUtc -Schedule $assignmentscheduletsr -DeadlineDateTime $Time_available.Value -UseUtcForExpireSchedule $CM_tseUtc -Availability Clients -RerunBehavior RerunIfFailedPreviousAttempt -CollectionId $CM_DCollection.collectionID -ShowTaskSequenceProgress $tsRProgressBar -RunFromSoftwareCenter $installfromsoftwarecneter -PersistOnWriteFilterDevice $false -Comment $CM_TSrcomment -SoftwareInstallation $CM_tsrmtwoverride -SystemRestart $CM_tsrOutMTWReboot
