...
<Settings>
    <MECMSettings>
        <MECMSITECODE>BEL</MECMSITECODE>
        <MECMSERVER>Cwypwd-25</MECMSERVER>
    </MECMSettings>
    <EmailSettings>
        <SMTPServer>App-mail.bell.corp.bce.ca</SMTPServer>
        <FromAddress>MECM_Automation@bell.com</FromAddress>
        <CCAddress>Bell.SCCM.Ops.IN@cgi.com</CCAddress>
        <BCCAddress></BCCAddress>
    </EmailSettings>
    <ToolSettings>
        <MailList>sunil.huchaiah@cgi.com;k.govindaraj@cgi.com;akhil.joropalli@cgi.com;varun.mc@cgi.com;mohanapriya.velusamy@cgi.com;antonypraveen.kumar@cgi.com;geeta.muddangoudar@cgi.com;suhasini.lambunoore@cgi.com</MailList>
